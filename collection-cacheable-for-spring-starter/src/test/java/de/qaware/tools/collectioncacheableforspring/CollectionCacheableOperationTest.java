...
public class CollectionCacheableOperationTest {
    ...
    public void testToStringAndEqualsAndHashCode() {
        ...
        assertThat(collectionCacheableOperation1)
                .hasToString("Builder[name] caches=[cacheName1, cacheName2] | key='key' | keyGenerator='keyGenerator' | cacheManager='cacheManager' | cacheResolver='cacheResolver' | condition='condition' | unless='unless' | isFindAll=true | putNull=true")
